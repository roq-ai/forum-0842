...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Reaction', path: '/reactions', entity: 'reaction', service: AccessServiceEnum.PROJECT, icon: FiSmile },
    { name: 'Thread', path: '/threads', entity: 'thread', service: AccessServiceEnum.PROJECT, icon: FiMessageCircle },
